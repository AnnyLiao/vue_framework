    ...
    <f7-navbar :sliding="false">
      <f7-block no-hairlines style="width: 100%">
        <f7-row>
          ...
          <f7-col width="20">
            <f7-button small fill @click="getMachineName">確認</f7-button>
          </f7-col>
      ...
      Object.keys(vm.Interval_UAPQ).forEach(item => {
        if (item != "timestamp") {
          ...
          chart.data = [
            {
              category: item,
              value: Math.round(vm.Interval_UAPQ[item]),
              full: 100
            }
          ];
          ...
          if(chart.data[0].value < 30){
            series2.columns.template.radarColumn.fill = am4core.color(vm.colors[2]);
          }else if(chart.data[0].value > 70){
            series2.columns.template.radarColumn.fill = am4core.color(vm.colors[0]);
          }else {
            series2.columns.template.radarColumn.fill = am4core.color(vm.colors[1]);
          }
